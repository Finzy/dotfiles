...
tags = {
   ...
   layout = { layouts[2], layouts[3], layouts[4], layouts[1], layouts[7], layouts[1] }
}
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Control" }, "l",      function () awful.tag.incncol(-1)          end), awful.key({ modkey, "Control" }, "h",      function () awful.tag.incncol( 1)          end),
